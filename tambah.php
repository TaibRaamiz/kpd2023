...
<head>
    ...
    <title>Borang Markah Penilaian Berterusan Kohort 2019</title>
</head>
<style type="text/css">
    h2 {
        text-align: center;
...
<body>
    <center>
        ...
        <form action="" method="post">
            ...
            <tr>
                <td>Gred Teori</td><td>:</td><td> <select name="gred_teori" required>
            ...
            <tr>
                <td>Gred Amali</td><td>:</td><td> <select name="gred_amali" required>
                    <option value="A+">A+</option>
                    <option value="A">A</option>
                    <option value="A-">A-</option>
                    <option value="B+">B+</option>
